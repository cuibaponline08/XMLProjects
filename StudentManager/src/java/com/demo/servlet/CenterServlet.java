...
public class CenterServlet extends HttpServlet {
    ...
    private static String SearchServlet = "SearchServlet";
    private static String createServlet = "CreateServlet";
    private static String updateServlet = "UpdateServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (button.equals("Search")) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher(createServlet);
                rd.forward(request, response);
